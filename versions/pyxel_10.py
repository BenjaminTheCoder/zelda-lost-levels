...
def draw():
    ...
    if updatedplayer.slashing == True:    
        if updatedplayer.direction == 'down':
            slash = pyxel.blt(updatedplayer.x, updatedplayer.y + TILESIZE, 0, 16, 32, 16, 16, 7)
        elif updatedplayer.direction == 'up':
            slash = pyxel.blt(updatedplayer.x, updatedplayer.y - TILESIZE, 0, 64, 0, 16, 16, 7)
        elif updatedplayer.direction == 'right':
            slash = pyxel.blt(updatedplayer.x + TILESIZE, updatedplayer.y, 0, 32, 32, 16, 16, 7)
        elif updatedplayer.direction == 'left':
            slash = pyxel.blt(updatedplayer.x - TILESIZE, updatedplayer.y, 0, 48, 32, 16, 16, 7)
